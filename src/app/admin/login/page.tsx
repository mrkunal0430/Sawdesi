...
import { Leaf, AlertCircle, Shield } from "lucide-react";
...
function AdminLoginContent() {
  ...
  const errorMessages: Record<string, string> = {
    ...
    access_denied: "Your account does not have admin access.",
  };
    ...
    <div className="min-h-screen bg-forest-dark flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-sm">
        ...
        <div className="flex items-center justify-center gap-2 mb-8">
          ...
          <span
            className="text-3xl font-bold text-cream tracking-tight"
        ...
        <div className="bg-white rounded-3xl border border-border p-8 shadow-xl">
          ...
          <Button
            ...
            size="lg"
            variant="ghost"
            className="w-full gap-3 border-border hover:bg-cream-dark"
            loading={isLoading}
          >
